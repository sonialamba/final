  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			...
			<div color="red"class="container container-fluid"> 
			<p>IMPORTANT NOTICE FOR ALL MENTORS AND MENTEES
			
			Our Annual Intervention for all mentors and mentees 
			is scheduled on 27th July Thursday 2016 at 6pm 
			at Hotel Taj Mahal Palace.
			...
			<p> You have successfully worked 70% of the time.
			Congratulations !
